...
### DCT coefficient matrix (A) and input matrix (B).

![Waveform Output](DCT_1d_test01_1234_mat.png)

### Actual multiplied output. 
...
### DCT coefficient matrix (A) and inout matrix (B).

![Waveform Output](DCT_1d_test02_5721_mat.png)

### Actual multiplied output it should generate. 
